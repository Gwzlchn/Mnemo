...
class ParseArticleStep(StepBase):
    def validate_inputs(self) -> list[str]:
        # 仅依赖 00_download 写入的原始 HTML，meta 可选
    ...
    def execute(self) -> dict | None:
        ...
        # 合并 00_download 写入的 article_meta.json（更可信的来源元数据）
        ...
        # 从纯文本构造单一 section，章节切分留给 17_article_sections
        sections = []
        if text:
            sections.append({
                "level": 1,
...
if __name__ == "__main__":
    ParseArticleStep.cli_main("16_parse_article")
